...
public class WeatherViewModel: ObservableObject {
  ...
  private func loadCachedData() {
    ...
    do {
      ...
      Logging.log.error(
        "Failed to decode cached weather: \(String(describing: error), privacy: .public)")
    }
  }
  ...
  private func saveToCache(_ data: WeatherData) {
    do {
      ...
      Logging.log.error(
        "Failed to encode weather for cache: \(String(describing: error), privacy: .public)")
    }
  }
  ...
  private func loadHistory() {
    ...
    do {
      ...
      Logging.log.error(
        "Failed to decode weather history: \(String(describing: error), privacy: .public)")
  ...
  public func search(query: String) async {
    ...
    do {
      ...
      Logging.log.error("Search error: \(String(describing: error), privacy: .public)")
      DispatchQueue.main.async { self.errorMessage = "Search failed" }
    }
  }
